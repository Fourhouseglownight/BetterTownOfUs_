...
namespace BetterTownOfUs
{
    ...
    public static class PingTracker_Update
    {
        ...
        public static void Postfix(PingTracker __instance)
        {
            ...
            position.DistanceFromEdge = new Vector3(3.1f, 0.02f, 1);
            ...
            __instance.text.text =
                ...
                (!MeetingHud.Instance
                    ...
                    : "");
            if (MeetingHud.Instance) PingTracker_Update.spriteObject.transform.localPosition =  new Vector3(-1.1f, -0.6f, 1);
        }
    }
}
