...
namespace BetterTownOfUs.Modifiers.AssassinMod
{
    ...
    public class AddButton
    {
        ...
        private static bool IsExempt(PlayerVoteArea voteArea)
        {
            ...
            if (
                player == null ||
                (PlayerControl.LocalPlayer.Data.IsImpostor() && player.Data.IsImpostor()) ||
                player.Data.IsDead ||
        ...
        private static Action Guess(Assassin role, PlayerVoteArea voteArea)
        {
            void Listener()
            {
                ...
                else if (playerModifier != null) toDie = (playerRole.Name == currentGuess || playerModifier.Name == currentGuess) ? playerRole.Player : role.Player;
                if (CustomGameOptions.AssassinProtection == true && AssassinKill.HaveFailedGuess == false && role.Player.Data.IsImpostor() && toDie == role.Player ) AssassinKill.RpcAssassinFail(role.Player.PlayerId,targetId);
                else
                {
