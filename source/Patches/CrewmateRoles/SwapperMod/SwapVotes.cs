...
namespace BetterTownOfUs.CrewmateRoles.SwapperMod
{
    ...
    public class SwapVotes
    {
        ...
        public static class VotingComplete
        {
            ...
            {
                PluginSingleton<BetterTownOfUs>.Instance.Log.LogMessage(Swap1 == null ? "null" : Swap1.ToString());
                PluginSingleton<BetterTownOfUs>.Instance.Log.LogMessage(Swap2 == null ? "null" : Swap2.ToString());
