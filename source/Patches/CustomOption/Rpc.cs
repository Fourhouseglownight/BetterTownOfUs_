...
namespace BetterTownOfUs.CustomOption
{
    public static class Rpc
    {
        ...
        {
            PluginSingleton<BetterTownOfUs>.Instance.Log.LogInfo("Options received:");
            while (reader.BytesRemaining > 0)
            {
                ...
                PluginSingleton<BetterTownOfUs>.Instance.Log.LogInfo($"{customOption?.Name} : {customOption}:");
            }
        }
    }
}