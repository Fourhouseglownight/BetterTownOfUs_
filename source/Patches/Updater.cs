...
namespace BetterTownOfUs {
    ...
    public class ModUpdater { 
        ...
        public static void LaunchUpdater() {
            ...
            string submergedPath = System.Uri.UnescapeDataString(uri.Path.Replace("BetterTownOfUs", "Submerged"));
        ...
        public static async Task<bool> checkForUpdate(string updateType = "BTOU") {
            ...
            try {
                ...
                BetterTownOfUs.Logger.LogMessage(ex);
            }
            return false;
        }
        ...
        public static async Task<bool> downloadUpdate(string updateType = "BTOU") {
            ...
            try {
                ...
                if (updateType == "Submerged") {
                    fullname = fullname.Replace("BetterTownOfUs", "Submerged"); //TODO A better solution than this to correctly name the dll files
                }
